...
\begin{frame}[fragile]{Casos de Teste de Erro}
    A robustez da análise semântica em cenários de falha.
...
\begin{frame}{Conclusão das Etapas 1 e 2}
    \begin{itemize}
        \item Arquitetura sólida e extensível em Haskell com o Megaparsec.
        \item Sistema de tipos Genéricos e funções de ordem superior.
        \item Interpretador funcional pronto para servir de referência.
    \end{itemize}
\end{frame}
